insert into users( name, last_name, phone, city, email, github, linkedin, skype,  about) values('Lukasz', 'Kusa', '539 413 521', 'Wrocław', 'lukaszkusa@outlook.com', 'https://github.com/lukaszkusa/portfolio',
