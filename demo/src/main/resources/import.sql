insert into users(id, name, last_name, phone, city, email, github, linkedin, skype,  about) values(1, 'Lukasz', 'Kusa', '539 413 521', 'Wrocław', 'lukaszkusa@outlook.com', 'https://github.com/lukaszkusa/portfolio',
...
insert into school(id, name,speciality, direction, diploma_work, degree, start_date, end_date, user_id) values(1, 'WROCLAW SCHOOL OF INFORMATION TECHNOLOGY "HORYZONT" ', 'Computer Networks', 'IT', '"Analysis of selected aspects of TLS protocol security"','Master', '10.2017', '09.2020', 1);
insert into school(id, name,speciality, direction, diploma_work, degree, start_date, end_date, user_id) values(2, 'WROCLAW SCHOOL OF INFORMATION TECHNOLOGY "HORYZONT" ', 'Cryptography', 'IT', '"Hardware encryption using Raspberry-Pi"','Engineer', '10.2013', '02.2018', 1);
insert into school(id, name, direction, degree, start_date, end_date, user_id) values(3, 'IT TECHNICAL SCHOOL, KLODZKO ', 'IT' ,'TECHNICIAN', '09.2009', '06.2013', 1);
...
insert into work(id, position, company, city, start_date, start_end, user_id )values(1, 'PRODUCTION WORKER','ABB INDUSTRIAL SOLUTIONS', 'KLODZKO', '10.2018', 'UNTIL-NOW', 1);
